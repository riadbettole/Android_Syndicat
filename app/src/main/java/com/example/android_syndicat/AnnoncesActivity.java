...
public class AnnoncesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        DatabaseReference root = db.getReference().child("annonces");
    ...
    public void goToPreviousActivity(View view){
        startActivity(new Intent(AnnoncesActivity.this, MainActivity.class));
        finish();
    }
    ...
    private void displayButtons() {
        ...
        userRef.child("role").get().addOnCompleteListener(task -> {
            if (!task.isSuccessful()) {
                Toast.makeText(AnnoncesActivity.this, "Error retrieving last position", Toast.LENGTH_SHORT).show();
                return;
            }
    ...
    public void onClickChangeToAdd(View view){
        startActivity(new Intent(AnnoncesActivity.this, AnnonceAddActivity.class));
        finish();
    }
